...
const detailedFeatures = [
  ...
  { feature: 'Role-based access control', starter: '-', professional: '-', business: '4 roles, 31 permissions' },
  { feature: 'Team management dashboard', starter: '-', professional: '-', business: 'Yes' },
  { feature: 'Email team invitations', starter: '-', professional: '-', business: 'Yes' },
